...
class GraphUnittest(unittest.TestCase):
    ...
    def test_levels(self):
        ...
        self.assertListEqual(self.network.levels("A"), [1, 2, 3, 2, 2])
        self.assertListEqual(self.network.levels("C"), [1, 2, 2, 2, 2, 1])
        self.assertListEqual(self.network.levels("G"), [1, 3, 4, 2])
        self.assertListEqual(self.network.levels("F"), [1, 2, 2, 3, 2])
